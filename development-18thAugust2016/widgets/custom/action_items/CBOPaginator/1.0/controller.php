...
class CBOPaginator extends \RightNow\Widgets\Paginator {
     ...
     function getData()
    {
        ...
        $results = $this->CI->model('custom/ReportCustomModel')->getDataHTML($this->data['attrs']['report_id'], $reportToken, $filters, null)->result;
