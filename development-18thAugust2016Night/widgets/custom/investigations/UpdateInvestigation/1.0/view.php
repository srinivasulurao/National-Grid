...
<a href="/app/customer_feedback/investigations/update/i_id/<?php echo getUrlParm('i_id'); ?>"  class="btn success_button">Refresh</a>
...
<span id='contact_look_up' style='position:relative;bottom:20px;'></span>
<rn:widget path="input/FormSubmit" label_button="Submit " on_success_url='none' error_location="rn_ErrorLocation2" label_on_success_banner="Thread Saved Successfully, A mail has been sent to the user to get further inputs for the complaint !"  />
</form>
