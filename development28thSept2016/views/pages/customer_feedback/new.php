...
<div class="rn_PageContent rn_AskQuestion rn_Container">
	...
	<div class="rn_Hidden">
      ...
      <span id='sold_to_cust' style="display: none"><rn:widget path="input/TextInput"  name="Incident.c$sold_to_customer_name" default_value="" label_input="Sold to Customer Name" required="true" /></span>
...
<!--         <rn:widget path="input/TextInput"  name="Incident.c$product_no" default_value="" label_input="Product Number" required="true" /> -->
	    ...
	    <rn:widget path="custom/input/ProductCategoryInput" name="Incident.Product" label_input="Product Line" default_value="" required="true" />
 	    <span class='prod_cat_sel'><rn:widget path="input/ProductCategoryInput"  name="Incident.Category" default_value="" required="false" /></span>
        ...
        <rn:widget path="input/TextInput"  name="Incident.Threads" default_value="" label_input="Comments"  required="true"/>
