...
Custom.Widgets.customer_feedback.FormFunctionalityProvider = RightNow.Widgets.extend({
    ...
    constructor: function() {
            ...
            if(inc_id){
                ...
                //Disable the draft option if the incident is not saved as draft while creation.
                var save_as_draft_recorded=document.getElementById('save_as_draft_recorded').value;
                if(!save_as_draft_recorded){
                	document.getElementsByClassName('save_as_draft')[0].innerHTML="";
                }
