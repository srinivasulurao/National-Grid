<rn:meta title="View Supplier Complaint" template="standard.php" login_required="true"/>
<style>
    .rn_Label{
...
<div class="rn_PageContent rn_AskQuestion rn_Container">
        ...
        <div id="rn_ErrorLocation"></div>
                ...
                <rn:widget path="output/FieldDisplay" name="Incident.c$supplier_order_number" required="true" label="PO Number">
