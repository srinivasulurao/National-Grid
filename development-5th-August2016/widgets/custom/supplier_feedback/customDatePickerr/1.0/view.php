...
<div id="demo" class="yui3-skin-sam yui3-g" style="width:50%"> <!-- You need this skin class -->
  ...
  <div id="leftcolumn" class="yui3-u">
	...
	<div class='label_input'><?=$this->data['attrs']['label_input'];?>
			...
			<input style="width:202px;" type="text" id="rn_<?=$this->instanceID;?>_<?=$str_custom_object;?>" name="rn_<?=$this->instanceID;?>_<?=$this->data['attrs']['name'];?>" value="<?=$this->data['duedate'];?>" readonly="readonly"  />
