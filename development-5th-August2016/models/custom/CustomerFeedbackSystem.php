...
class CustomerFeedbackSystem extends \RightNow\Models\Base
{
    ...
    function CustomerCompliantCreation($data){
        ...
        try{
            ...
            if($formData['Incident.CustomFields.c.sold_to_customer_name'])
                $incident->CustomFields->c->sold_to_customer_name=$formData['Incident.CustomFields.c.sold_to_customer_name'];
            if($formData['Incident.CustomFields.c.ship_to_customer_name'])
                $incident->CustomFields->c->ship_to_customer_name=$formData['Incident.CustomFields.c.ship_to_customer_name'];
            if($formData['Incident.CustomFields.c.product_no'])
                $incident->CustomFields->c->product_no=$formData['Incident.CustomFields.c.product_no'];
