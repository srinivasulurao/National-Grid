    	...
    	var form = RightNow.Form.find("investigation_closure_form", this.instanceID);
            ...
            if(eo.data.value==1)
               ...
               if(why1=="" || why2=="" || why3==""){
				     ...
				     errorString="<b><a href='javascript:void(0)' onclick=\"document.getElementsByClassName('yahoo_date_selected')[0].focus(); return false;\">Please provide atleast three reasons behind the problem !</a></b><br>";
