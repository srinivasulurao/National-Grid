<div id="rn_<?= $this->instanceID ?>" class="<?= $this->classList ?> inv-div" >
		...
		<div class='tab_playground'>
	        ...
	        <rn:widget path="custom/action_items/customFileDisplay" type="parent_incident"/>
	        <rn:widget path="custom/investigations/CustomThreadDisplay" type="parent_incident" />
	      </div>
		...
		<div id='investigation_content' style='display:none' >
				<table class='actiontable' style='width:70%;margin:auto;margin-top:20px;border:1px solid lightgrey'>
				...
				<div id='thread_display' style='font-size:12px'>
	<rn:widget path="output/FileListDisplay" label="File Attachments" display_thumbnail="false" name="Incident.FileAttachments"/>
