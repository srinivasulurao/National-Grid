...
foreach($this->data['child_investigations'] as $ci):
  $html.="<li style='border-bottom:1px dashed lightgrey;background: white;padding: 10px;width: 99%;'>&#x2611; <a href='/app/investigations/view/i_id/{$ci['ID']}'  target='_blank'>{$ci['Subject']}</a><li>";
  $counter++;
endforeach;
endif;
