...
<div class="rn_PageContent rn_AskQuestion rn_Container investigations">
    ...
    <h1>Corrective Actions <span id='total_corrective_actions'></span> <span id='plus_minus2' onclick='playToggle(2)'>+</span></h1>     
    <div class='collapsible-div investigation-playstation-2' style='display:none'><rn:widget path="custom/investigations/CorrectiveActions" /></div>
  
    <h1>Thread <span id='plus_minus3' onclick='playToggle(3)'>+</span></h1>     
    <div class='collapsible-div investigation-playstation-3' style='display:none'><rn:widget path="custom/investigations/UpdateInvestigation" /></div>
