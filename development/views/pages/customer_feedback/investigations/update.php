...
<div class="rn_PageContent rn_AskQuestion rn_Container investigations">
    ...
    <div class='collapsible-div investigation-playstation-3'><rn:widget path="custom/investigations/UpdateInvestigation" /></div>
    
    <h1>Investigation Closure <span id='plus_minus4' onclick='playToggle(4)'>+</span></h1>     
    <div class='collapsible-div investigation-playstation-4'><rn:widget path="custom/investigations/InvestigationClosure" /></div>
