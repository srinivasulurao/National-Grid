<rn:meta title="Add Supplier Complaint" template="standard.php" clickstream="supplier_create" login_required="true"/>

<div class="rn_Hero">
    <div class="rn_HeroInner">
        <div class="rn_HeroCopy">
		<h1>Please Provide Supplier Feedback</h1>
...
<div class="rn_PageContent rn_AskQuestion rn_Container">
	...
	<rn:widget path="custom/supplier_feedback/TypeAheadSupplierLookup" name="CFS.Supplier.Name" required="true"  label_input="Supplier name" required="true"/>
	...
	<rn:widget path="input/TextInput"  name="Incident.Threads" label_input="Messages" required="true" /> 
	<rn:widget path="input/TextInput"  name="Incident.c$proposed_solution" label_input="Proposed Solution" required="true"  /> 
