<rn:meta title="Customer Feedback List" template="standard.php" clickstream="list" login_required="true"//>
...
<div class="rn_PageContent rn_AskQuestion rn_Container cfl" style='min-height:600px'>
    ...
    <rn:widget path='custom/action_items/StatusFilter' action="/app/customer_feedback/list" label_name="Choose Status" entity_type="customer_feedback"  />
    <rn:widget path='custom/action_items/ProductLineFilter' action="/app/customer_feedback/list" label_name="Choose Product Line" entity_type="customer_feedback"  />
