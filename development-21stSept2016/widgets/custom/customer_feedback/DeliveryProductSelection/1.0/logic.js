    ...
    constructor: function() {
      ...
      form.on("submit", this.onValidate, this);
    	...
    	var target_instance_id="";
         ...
         var pro_chosen=Y.one(".rn_ProductCategoryInput");
         pro_chosen.on('click',function(e){
         document.getElementsByClassName('rn_DeliveryProductSelection')[0].innerHTML=""; //make the div empty if someone select the new product.
         });
