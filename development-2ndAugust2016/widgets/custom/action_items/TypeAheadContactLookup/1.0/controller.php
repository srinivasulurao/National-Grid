...
class TypeAheadContactLookup extends \RightNow\Libraries\Widget\Input {
    ...
    function getData() {
	 ...
	 $data_value = $this->CI->CustomerFeedbackSystem->getdatavalues($pack,$this->table,$this->fieldName,$url_id);
	  $cname = $this->CI->CustomerFeedbackSystem->getcontact($data_value->ID);
		$this->data['field']->value=intval($data_value->ID);
