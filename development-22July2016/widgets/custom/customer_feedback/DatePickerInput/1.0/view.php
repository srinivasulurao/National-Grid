...
<input type='text' value='<?php echo $this->data['target_date']; ?>' readonly placeholder="Example : 2013-05-29" class='rn_Text yahoo_date_selected' <?php echo ($this->attrs['required']->value)?"required='true'":""; ?> name="<?php echo $this->attrs['name']->value; ?>" id='<?php echo $widget_id; ?>' style="width:200px;display:inline-block" >&nbsp<img style='height:20px;width:20px;top:5px;position: relative;cursor:pointer' id='toggleCalendar' src='http://eguidemagazine.com/wp-content/uploads/2016/06/calendar-icon-blue_sm.png'>
