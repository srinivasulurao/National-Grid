...
<div class="rn_PageContent rn_AskQuestion rn_Container">
	...
	<rn:widget path="input/TextInput"  name="Incident.Threads" label_input="Messages"  /> <br>
	...
	<rn:widget path="input/SelectionInput"  name="Incident.c$request_type" label_input="Request Type"  /> <br>
