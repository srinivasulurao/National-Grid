...
<input style="width:202px;" type="text" id="rn_<?=$this->instanceID;?>_<?=$str_custom_object;?>" name="rn1_<?=$this->instanceID;?>_<?=$this->data['attrs']['name'];?>" value="<?=$this->data['duedate'];?>" readonly />
