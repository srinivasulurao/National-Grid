...
<div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/cc/CustomerFeedbackSystem/updateCustomerComplaintSendForm/<?php echo getUrlParm('i_id'); ?>">
        <div id="rn_ErrorLocation"></div>
                ...
                <span id='product_number_suggestions'></span>                <rn:widget path="input/ProductCategoryInput" label_input='Product Line' name="Incident.Category" default_value="" required="true" />
...
it" label_button="Submit Complaint" on_success_url="/app/customer_feedback/confirm" error_location="rn_ErrorLocation"/><br><br>
