...
<form method='action' id='add_corrective_action' style='display:none' onsubmit="return false;">
    ...
    <input type='text' id='corrective_actions_completion_date' placeholder="mm-dd-yyy">
    <label>Due Date</label>
    <input type='text' id='corrective_actions_due_date' placeholder="mm-dd-yyy">		
	</select>
	<button class='success_button' id='submitCorrectiveAction' type="submit">Submit</button>
	<input type='hidden' value='<?php echo getUrlParm('i_id'); ?>' id='corrective_actions_iid' />
</form>
</div>
 !important;display: none;position:absolute;'></div>
    <label>Due Date</label>
